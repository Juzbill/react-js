...
export default function Products({}: ITabMenu) {
  ...
  return (
    ...
    >
      <ProductMenuList itemData={itemData} />
...
const ProductMenuList = ({ itemData }: IProductMenuList) => {
  return (
    <div className="bg-white 2xl:w-[25%]  xl:w-[40%] p-4">
      ...
      <div className="flex flex-col justify-start gap-2 mt-2">
        {itemData.map((item, index) => (
          ...
          >
            <TextBody text={item.itemName} />
            <div className="flex flex-row justify-center items-center gap-6">
              <TextBody text={item.quanity.toString()} color="red" />
              <IconButton aria-label="" onClick={() => {}}>
                <SVG
