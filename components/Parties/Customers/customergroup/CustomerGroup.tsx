            ...
            >
              <Grid container alignItems="center">
                <Grid
                  ...
                  xs={6}
                  className="cx-detail-left"
                  sx={{ width: "130px", display: "flex", padding: "8px 10px" }}
                >
                  <Typography
                    variant="h6"
                ...
                <Grid
                  ...
                  xs={4}
                  className="cx-detail-right"
                  sx={{ width: "98px", display: "flex", padding: "8px 10px" }}
                >
                  <Typography
                    variant="h6"
                    sx={{
        ...
        >
          <Box>
            ...
            <Box sx={{ marginLeft: "10px", display: "flex" }}>
              ...
              <Typography sx={{ color: "green", marginLeft: "9px" }}>
                {" "}
                Rs 0.00
              </Typography>
            </Box>
          ...
          >
            <Box sx={{ display: "flex" }}>
              <Box
                sx={{ width: "222px", marginLeft: "10px", marginTop: "25px" }}
              >
                <Typography
                  variant="h6"
