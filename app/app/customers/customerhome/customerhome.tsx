...
const CustomerHome: React.FC = () => {
  return (
    ...
    <Box className="groups" sx={{ width: '137px' }}>
      <Typography variant="h5" sx={{ color: '#1A1A1A', fontWeight: 500, padding: ' 12px 24px', fontSize:'14px', textTransform: 'uppercase' }}>
        Groups
      </Typography>
    </Box>
    </Box>
...
<InputBase placeholder='Search' fullWidth sx={{border: 'none',outline: 'none',color: '#b3b3b3',fontSize: '14px',marginLeft:'8px',fontWeight:'400'}}/>
      ...
      <Box className="cx-detail-bal-wrapper" sx={{ width: '90%', height: 'auto', marginLeft: '16px', marginTop: '8px' }}>
      <Paper elevation={0} className="cx-detail-filter-wrapper" sx={{ background: '#f6f6f6', border: '1px solid #e6e6e6' }}>
    ...
    <Box className="cx-bal-detail-wrapper" sx={{ display: 'flex' }}>
      <List component="ul">
        {customerbalance.map((customer, index) => (
          <ListItem key={index} className="cx-balance">
            <ListItemText>
              <Typography variant="h6" className="cx-balance-name" sx={{ width:'150px', color: '#666', fontSize: '16px', fontWeight: 400, padding: '8px 0px 8px 10px' }}>
                {customer.name}
              </Typography>
            </ListItemText>
            <ListItemText>
              <Typography variant="h6" className="cx-balance-amount" sx={{ padding:'8px',color: '#12B76A', fontSize: '16px', fontWeight: 500 }}>
                {customer.balance}
              </Typography>
            </ListItemText>
      ...
      <Box className="cx-rightwrapper" sx={{ width:'692px', height: '590px', borderRadius: '8px 8px 0px 0px',  marginLeft: '16px', display: 'flex',background: '#FFF', position:'relative'}}>
 ...
 <List>
  ...
  <List>
    ...
    <Box className="cx-gst" sx={{display:'flex', alignItems:'center'}}>
      ...
      <Typography className="cx-gstvalue" variant="body2"sx={{color:'#06F'}}>
        Add GSTIN
      </Typography> 
    </Box>
    </Box>
...
<Box className="cx-reminders" sx={{marginTop:'25px', marginRight:'80px'}}>
<Box className="cx-reminders-wrapper" sx={{width:'140px', height:'36px',marginBottom:'8px', display:'flex', padding: '8px 16px',alignItems: 'center', borderRadius: '8px',border: '0.5px solid rgba(32, 32, 32, 0.10)',background: 'rgba(206, 244, 219, 0.50)'}}>
      <Image src="/Customers/whattsapp.svg" alt="whatsapp" width={20} height={20} />
      <Typography  sx={{fontSize: '12px', fontWeight: 400, padding: '8px'}}>Whatsapp</Typography>
    ...
    <Box className="cx-reminders-wrapper" sx={{width:'140px', height:'36px', display:'flex', padding: '8px 16px',alignItems: 'center', borderRadius: '8px',border: '0.5px solid rgba(32, 32, 32, 0.10)',background: 'rgba(206, 244, 219, 0.50)'}}>
      <Image src="/Customers/sms.svg" alt="sms" width={20} height={20} />
      <Typography  sx={{fontSize: '12px', fontWeight: 400, padding: '8px'}}>SMS</Typography>
