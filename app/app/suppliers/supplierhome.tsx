...
background: 'linear-gradient(113deg, rgba(230, 230, 230, 0.25) 12.31%, rgba(240, 240, 240, 0.05) 57.41%, rgba(230, 230, 230, 0.10) 123.61%)', margin:'18px'}}>
    <Box className="sup-profile" sx={{width: '660px',height: '32px', background: 'rgba(230, 230, 230, 0.30)', display:'flex', marginTop:'14px'}}>
  ...
  <Box className="sup-address-wrapper" sx={{marginLeft:'20px'}}>
    <Box className="sup-phone" sx={{display:'flex', alignItems:'center', marginTop:'15px'}}>
